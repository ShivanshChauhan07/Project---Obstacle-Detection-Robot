...
#define TRIG_PIN A1 // Pin A1 on the Motor Drive Shield soldered to the ultrasonic sensor

#define ECHO_PIN A0 // Pin A0 on the Motor Drive Shield soldered to the ultrasonic sensor
